...
在本章，我们首先介绍P-TOPO程序的结构，之后分别介绍了PIC和Symplectic在GPU上的实现，其中PIC算法也在CPU集群上进行了实现。
...
\section{Symplectic算法在GPU上的实现}            
\label{section:symplectic_GPU}
...
我们在GPU上使用使用CUDA库实现了基于PIC方法的多粒子模拟程序，并对如何避免竞争条件和实现更高性能的GPU代码结构和并行策略进行了介绍。
